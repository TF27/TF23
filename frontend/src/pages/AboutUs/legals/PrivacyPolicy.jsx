...
function PrivacyPolicy(){
    ...
    return (
        ...
        <div className="item" >
        <li style={{marginBottom:'10px'}} className=" list-group-item text-light bg-dark bg-opacity-50 border border-light border-1 rounded" onClick={() => setToggle1(!toggle1)}>GENERAL DATA PROTECTION RULES (GDPR)</li>
        {toggle1 &&(<div style={{marginBottom:'10px',transition:'ease-in-out' }}  className="drop-content border border-light border-1" >
...
The right to withdraw consent</p>
        ...
        <div className="item" >
        <li style={{marginBottom:'10px'}}  className="list-group-item text-light bg-dark bg-opacity-50 border border-light border-1 rounded" onClick={() => setToggle2(!toggle2)}>LOG FILES</li>
        {toggle2 &&(<div style={{marginBottom:'10px'}}  className={`drop-content  ${toggle2 ? 'active' : ''}`}>
        ...
        <div className="item">
        <li style={{marginBottom:'10px'}}  className="list-group-item text-light bg-dark bg-opacity-50 border border-light border-1 rounded" onClick={() => setToggle3(!toggle3)}>COOKIES AND WEB BEACONS</li>
        {toggle3 &&(<div style={{marginBottom:'10px'}}  className="drop-content border border-light border-1">
        ...
        <div className="item">
        <li style={{marginBottom:'10px'}}  className="list-group-item text-light bg-dark bg-opacity-50 border border-light border-1 rounded" onClick={() => setToggle4(!toggle4)}>PRIVACY POLICIES</li>
...
Note that Techfest IIT Bombay has no access to or control over third-party advertisers' cookies.</p>
        ...
        <div className="item">
        <li style={{marginBottom:'10px'}}  className="list-group-item text-light bg-dark bg-opacity-50 border border-light border-1 rounded" onClick={() => setToggle5(!toggle5)}>THIRD-PARTY PRIVACY POLICIES</li>
...
You can choose to disable cookies through your individual browser options. It can be found on the browsers' respective websites to know more detailed information about cookie management with specific web browsers.</p>
        ...
        <div className="item">
        <li style={{marginBottom:'10px'}}  className="list-group-item text-light bg-dark bg-opacity-50 border border-light border-1 rounded" onClick={() => setToggle6(!toggle6)}>CHILDREN'S INFORMATION</li>
...
Techfest IIT Bombay does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately, and we will do our best efforts to remove such information from our records promptly.</p>
        ...
        <div className="item">
        <li style={{marginBottom:'10px'}}  className="list-group-item text-light bg-dark bg-opacity-50 border border-light border-1 rounded" onClick={() => setToggle7(!toggle7)}>ONLINE PRIVACY POLICY</li>
        ...
        <div className="item">
        <li style={{marginBottom:'10px'}}  className="list-group-item text-light bg-dark bg-opacity-50 border border-light border-1 rounded" onClick={() => setToggle8(!toggle8)}>CONSENT</li>
