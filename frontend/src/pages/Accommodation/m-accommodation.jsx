...
const MAccommodation = () => {
  ...
  const data = {
    rows: [
      ...
      },
      {
        ...
        content:
          "Confirmation is not confirmed till a confirmation mail is not received in 24 hours. If not received confirmation in 24 hours, then mail your transaction ID, Techfest ID, name, amount to nivesh@techfest.org with the subject as Transaction ID :: team ID :: Confirmation mail not received.",
      },
      {
  ...
  const tabContent = {
    "ABOUT US": (
      <>
        Techfest has been an example in achieving huge feats with unparalleled
        figures ever since its inception in 1998. Techfest has grown in stature
        in terms of its content, infrastructure and logistics. The overwhelming
        crowd of such a high magnitude and a world-class technological display
        along with a tinge of enjoyment has made our dream a technological
        extravaganza. With such vastness and diversity, the hospitality of the
        guests is of paramount importance. We, at Techfest, constantly strive
        towards the satisfaction of everyone. We shall leave no stone unturned
        in fulfilling the needs of a secure accommodation away from home. Along
        with accommodation facilities for our participants, we also set up a
        cafeteria serving a variety of cuisines satisfying the needs of every
        palate. We strive to make your stay comfortable and your experience, a
        memorable one. Hospitality management would be one of the prime focuses
        of Team Techfest 2023-24. Hope to see you at Techfest 2023-24. We will
        be more than happy to receive your suggestions and queries. Kindly email
        at hospitality@techfest.org
      </>
    ),
    "ACCOMMODATION POLICIES": (
      <table
      ...
      >
        <tr>
          ...
          <td>
            Accommodation charges are INR 2999 <s>3499</s> (Early Bird Offer)
            per candidate for 5 days. Maximum of 5 nights stay allowed (26th Dec
            6 AM - 30th Dec 10 AM). It does not include food facility. Guest can
            purchase their meals from the food court, night cafeteria or private
            hostel canteens or hostel messes at subsidized rates.
          </td>
        </tr>
        <br />
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            any cancellations before deadline, 75% of the total amount shall be
            refunded within 10 working days after the festival. There shall be
            no refunds for cancellation after the deadline.Deadline of
    ...
    INSTRUCTIONS: (
      <ol>
        ...
        <li>
          <p>
            Techfest 2023 and IIT Bombay will not be responsible for any mishaps
            that occur through the duration of stay for Techfest 2023.
          </p>
        </li>
      </ol>
    ),
    FAQs: (
      <div>
        ...
        <p>
          The payment procedure will be online. The accommodation charges are
          provided under the tab Accommodation Charges on the hospitality page.
          You will have to report at the accommodation desk near the Old
          Swimming Pool with the email printout and the mandatory documents.
          Failing to bring any of the documents may lead to the cancellation of
          your accommodation.
        </p>

        <h5>How do I know that my payment is confirmed?</h5>
        <p>
          Confirmation is not confirmed until a confirmation mail is received in
          24 hours. If you have not received confirmation in 24 hours, then
          email your transaction ID, Techfest ID, name, amount to
          nivesh@techfest.org with the subject as (Transaction ID :: team ID ::
        ...
        <p>
          It is mandatory for all guest participants to carry college IDs. This
          is for your own convenience. Moreover, you will be asked to produce
          your college ID cards at the time of allotment of rooms.
        </p>

        <h5>What are the Accommodation charges?</h5>
        <p>
          The accommodation charges and other necessary details regarding the
          payment will be available under the tab Accommodation Charges.
        </p>

        <h5>What kind of accommodation is provided?</h5>
        <p>
          Accommodation is provided on a shared basis inside campus hostels or
          outside hotels. One mattress, and enough space for keeping luggage and
          other essential commodities will be provided. Girls and boys will be
          accommodated separately. The number of guests in a room will be
          decided by Techfest and will be allotted by the Techfest team.
        </p>

        <h5>Does the accommodation facilities include food facilities?</h5>
        <p>
          No, the accommodation charges do not include food facilities. Guests
          can purchase their meals from the food court, night cafeteria, or
          private hostel canteens or hostel messes at just INR 50 per meal.
        </p>

        <h5>What are the food facilities inside IIT Bombay?</h5>
        <p>
          For all our guests and guest, we set up a huge cafeteria serving a
          variety of cuisines satisfying the needs of every palate. In addition,
          you can also eat in the many canteens, messes, and restaurants inside
          the campus.
        </p>

        <h5>Can I enter IIT Bombay campus at any time?</h5>
        <p>
          You can enter IIT Main gate anytime by showing a valid photo ID proof
          during 6 am to 10 pm; however, you need to have accommodation inside
          the campus to stay in the campus after 10 pm.
        </p>

        <h5>Can we get accommodation on the spot at Techfest?</h5>
        <p>
          No confirmation of accommodation will be provided. It is completely
    ...
    "REACHING IITB": (
      <>
        ...
        Buses. IIT Bombay is located at Powai, which is an eastern suburb in the
        North-Eastern part (Central Railway Line) of Mumbai.
        <br />
        ...
        through the following routes. <br />
        ...
        IIT Bombay. It is located on Central Railway line.
        <br />
        An auto rickshaw from Kanjur-Marg station to IIT Bombay Main Gate costs
        Rs.45 approx.
        <br />
        Important railway stations where you can get down are:
        <br />
        ...
        Bandra-Borivali and Sion-Mulund and should be preferred if you have some
        heavy luggage, which may otherwise cause you inconvenience while
        ...
        <br />
        Trains/buses should be preferred if you carry less baggage with you, say
        a small bag per person. Please beware of pickpockets in locals and BEST
        buses.
        <br />
        Southbound trains on all the Local train lines are more crowded in the
        morning and thus should be avoided if the passenger is carrying baggage.
        Similarly, the northbound trains in the evening are more crowded.
        <br />
        With respect to mornings at Kanjurmarg station, travelling from Mumbai
        CST, Dadar or Kurla would be less crowded that travelling from Kalyan or
        Thane.
        <br /> <br />
        ...
        routes of Mumbai
        <br />
        1. Every team has to register online on the official Techfest website
        for the competition.
        <br />
        2. A Team ID will be allocated to the team on registration which shall
        be used for future references.
        <br />
        3. The decision of the organizers or judges shall be treated as final
        and binding on all.
        <br />
        4. No responsibility will be held by Techfest, IIT Bombay for any late,
        lost or misdirected entries.
        <br />
        5. Note that at any point of time the latest information will be that
            ...
            >
              ...
              {activeTab === tab && (
                <div className={styles["m-content-rect1"]}>
                  <div className={styles["m-content-rect2"]}>
                    {tabContent[tab]}
                  </div>
                </div>
              )}
