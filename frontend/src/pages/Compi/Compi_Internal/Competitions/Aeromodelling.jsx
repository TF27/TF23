          ...
          >
            ...
            >
              <div className={styles.info_tab}>
                <div className={styles.info_data}>
                  ...
                  <li>
                    IIT Bombay zonal round:
                    <br />
                    27th-29th December 2023{" "}
                  </li>

                  <li>
                    Final at RVCE Bangalore:
                    <br />
                    February 2024{" "}
                  </li>
                </div>
            ...
            >
              <div className={styles.info_tab}>
                <div className={styles.info_data}>
                  <li>
                    1. Each team would be given two attempts in Qualifier round
                    and two attempts in Payload Round. Best score from both
                    attempts will be considered as a score for each round.
                  </li>

                  <li>
                    2. The timer will start after 30 seconds of the previous
                    team completing their attempt. The participants need to be
                    prepared in time and launch without delay after entering the
                    take-off zone.
                  </li>
                  <li>
                    3. The teams would lose their turn if they are not ready in
                    time.
                  </li>

                  <li>
                    4. The same aircraft should be used in both the rounds and
                    it should be the same one in the abstract. In case of
                    damages during the competition, teams can repair the same
                    aircraft but are not allowed to use a replacement. The
                    repaired aircraft should be ready in given time.
                  </li>
                </div>
              </div>
            </div>
