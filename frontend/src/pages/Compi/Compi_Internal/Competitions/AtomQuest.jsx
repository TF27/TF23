      ...
      <div className={styles.impdata}>
        ...
        <div className={styles.information}>
          <div id="About" className={`${styles.info} ${activeCity === 'About' ? styles.show : styles.hide}`}>
            ...
            Home automation is constructing automation for a domestic, mentioned as a sensible home or smart house. The problem statement involves the creation of an intelligent smart home appliance or system with specific characteristics. The objective is to develop a novel smart home technology that offers unique features and functionalities, differentiating it from existing solutions in the market
              </div>
            </div>
          </div>
