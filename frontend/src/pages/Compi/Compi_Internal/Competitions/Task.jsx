    ...
    const openCity = (cityName) => {
      ...
      const data = {
        rows: [
          ...
          {
            title: "Is it free to register for Task Whiz?",
      ...
      <div className={styles.impdata}>
        ...
        <div className={styles.information}>
          ...
          <div id="Structure" className={`${styles.info} ${activeCity === 'Structure' ? styles.show : styles.hide}`}>
            ...
            <br />
            Stage 2: <br />
            Teams that qualify the stage 1 will be invited to IIT Bombay for presenting their final solution during Techfest 2023-24
              </div>
            </div>
          </div>
