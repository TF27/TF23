...
const Datamatics = () => {
    ...
    const data = {
        rows: [
          {
            title: "Why should I participate in the Datamatics Hackathon?",
          ...
          },
          {
            ...
            content: 'Follow this steps for registration : www.techfest.org > Competitions > Datamatics Hackathon > Explore More -> Register > Fill all your details > You will be registered and now you must either Create a team/Join a team'
          },
          {
        ...
        <div className={styles.wabutton }><Whatsapplink walink={walink1} dslink={dslink1} target="_blank"/></div>
            ...
            <div>
                ...
                <div className={`${styles.whatd} ${open === 'About' ? styles.whatdOpen : ''}`}>
                    ...
                    <div className={`${styles.abt_rect2} ${styles.whatd_rect2}`}>Improve productivity and accuracy by intelligently automating tasks, processes and documents with TruBot RPA and TruCap+ IDP.
            ...
            <div>
                ...
                <div className={`${styles.whatd} ${open === 'Timeline' ? styles.whatdOpen : ''}`}>
                    <div className={`${styles.abt_rect1} ${styles.whatd_rect1}`}></div>
                    <div className={`${styles.abt_rect2} ${styles.whatd_rect2}`}>
                    Last date of registration and completing quiz:<br/>
                    10th December 2023<br/><br/>

                    {/* Round 1 Submission Deadline:<br/>
                    7th December 2023<br/><br/> */}

                    Round 1 Result announcement:<br/>
                    11th December 2023<br/><br/>

                    Final Round at IIT Bombay Campus:<br/>
                    28th December 2023</div>
                </div>
            </div>
            <div>
            ...
            <div>
                ...
                <div className={`${styles.whatd} ${open === 'Contact' ? styles.whatdOpen : ''}`}>
                    ...
                    <div className={`${styles.abt_rect2} ${styles.whatd_rect2}`}>
                    Mahak Kalra<br/>
                    <div className="col-3 contactMail" onClick={() => window.location.href = `mailto:mahak.techfest@gmail.com`}>mahak.techfest@gmail.com</div>
                    <div className="col-3 contactNum" onClick={() => window.location.href = `tel:8000657709`}>+91 80006 57709</div>
                    </div>
                </div>
            </div>
        </div>
