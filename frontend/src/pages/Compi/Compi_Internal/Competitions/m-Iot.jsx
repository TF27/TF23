...
const Iot = () => {
    ...
    const data = {
        rows: [
          {
            title: "Why should I participate in the TIH - IoT?",
          ...
          },
          {
            ...
            content: 'Follow this steps for registration : www.techfest.org > Competitions > TIH - IoT > Explore More -> Register > Fill all your details > You will be registered and now you must either Create a team/Join a team'
          },
          {
          ...
          },
          {
            ...
            content: 'Follow this process: www.techfest.org -> (hover on) Competitions -> Competitions -> TIH - IoT -> Explore -> Register -> Fill all your details -> Team -> Create a team -> Use the Registered Mail ID of other participants to add them to your team. They must be already registered before adding them to your team'
          },
          {
        ...
        <div className={styles.mWholeData}>
            ...
            <div>
                ...
                <div className={`${styles.whatd} ${open === 'About' ? styles.whatdOpen : ''}`}>
                    ...
                    <div className={`${styles.abt_rect2} ${styles.whatd_rect2}`}>IoT Technologies for Interconnecting Water, Land, and Air</div>
                </div>
            </div>
            <div>
            ...
            <div>
                ...
                <div className={`${styles.whatd} ${open === 'Contact' ? styles.whatdOpen : ''}`}>
                    ...
                    <div className="col-3 contactMail" onClick={() => window.location.href = `mailto:chiragrao@gmail.com`}></div>
