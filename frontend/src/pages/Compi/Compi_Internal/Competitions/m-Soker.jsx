...
const Soker = () => {
    ...
    const data = {
        rows: [
          ...
          {
            title: "Why should I participate in the Robosoccer?",
          ...
          },
          {
            ...
            content: 'Follow this steps for registration : www.techfest.org > Competitions > Robosoccer > Explore More -> Register > Fill all your details > You will be registered and now you must either Create a team/Join a team'
          },
          {
        ...
        <div className={styles.mWholeData}>
            ...
            <div>
                ...
                <div className={`${styles.whatd} ${open === 'About' ? styles.whatdOpen : ''}`}>
                    ...
                    <div className={`${styles.abt_rect2} ${styles.whatd_rect2}`}>Teams have to build a manually controlled Robo-soccer bot, which should be able to push or drag the ball in opponents goal, without gripping.</div>
                </div>
            </div>
            <div>
