...
const Race = () => {
    ...
    const walink1 = "https://chat.whatsapp.com/JR4MGOlI9T5Cyw6hOjRqYZ";
    const dslink1 = "https://chat.whatsapp.com/JR4MGOlI9T5Cyw6hOjRqYZ";
        ...
        <div className={styles.mWholeData}>
            ...
            <div>
                ...
                <div className={`${styles.whatd} ${open === 'About' ? styles.whatdOpen : ''}`}>
                    ...
                    <div className={`${styles.abt_rect2} ${styles.whatd_rect2}`}>Teams have to build a manually controlled Robo-Sumo bot, which should be able to push or drag the opponent bot, outside the ring.</div>
                </div>
            </div>
            <div>
