...
const Task = () => {
    ...
    const data = {
        rows: [
          {
            title: "Why should I participate in the Task Whiz?",
          ...
          },
          {
            ...
            content: 'Follow this steps for registration : www.techfest.org > Competitions > Task Whiz > Explore More -> Register > Fill all your details > You will be registered and now you must either Create a team/Join a team'
          },
          {
          ...
          },
          {
            ...
            content: 'Follow this process: www.techfest.org -> (hover on) Competitions -> Competitions -> Task Whiz -> Explore -> Register -> Fill all your details -> Team -> Create a team -> Use the Registered Mail ID of other participants to add them to your team. They must be already registered before adding them to your team'
          },
          {
        ...
        <div className={styles.mWholeData}>
            ...
            <div>
                ...
                <div className={`${styles.whatd} ${open === 'About' ? styles.whatdOpen : ''}`}>
                    ...
                    <div className={`${styles.abt_rect2} ${styles.whatd_rect2}`}>Design & Develop an intelligent task management system that leverages the concepts like AI, ML, Data Analytics and User Friendly Interface</div>
                </div>
            </div>
            <div>
            ...
            <br />
            Stage 2: <br />
            Teams that qualify the stage 1 will be invited to IIT Bombay for presenting their final solution during Techfest 2023-24</div>
                </div>
            </div>
            <div>
