      ...
      <div className={styles.impdata}>
        ...
        <div className={styles.information}>
          <div id="About" className={`${styles.info} ${activeCity === 'About' ? styles.show : styles.hide}`}>
            ...
            Unleash your creativity in the realm of space with the 'Space Exploration and Colonization' competition, celebrating Chandrayaan 3's success, where students build innovative robotics projects from scratch and showcase their skills at IIT Bombay.
              </div>
            </div>
          </div>
          <div id="Structure" className={`${styles.info} ${activeCity === 'Structure' ? styles.show : styles.hide}`}>
            ...
            <br />
            Stage 2: <br />
            Teams that qualify the RCAT will be selected for the national finals at IIT Bombay during Techfest 2023-24. Here they will be presenting their final projects to the judges in offline mode.
              </div>
            </div>
          </div>
          <div id="Timeline" className={`${styles.info} ${activeCity === 'Timeline' ? styles.show : styles.hide}`}>
            ...
            Last date to earn Green RoboCap & meet eligibility: 30 November, 2023 <br />
             <br />
            Round 2:<br/>
            Finale will be held at Techfest 2023-24 during 27th - 29th December 2023 (exact date and time of the competition will be conveyed to the finalists)
            </div>
            </div>
          </div>
          ...
          <div id="Contact" className={`${styles.info} ${activeCity === 'Contact' ? styles.show : styles.hide}`}>
            <div className={styles.info_tab}>
              ...
              Shreshth Raj<br/>
                    ...
                    <div className="col-3 contactMail" onClick={() => window.location.href = `shreshthraj.techfest@gmail.com`}>shreshthraj.techfest@gmail.com</div>
