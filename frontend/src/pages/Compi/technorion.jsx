            ...
            <div className={styles.compi_card}>
               ...
               <div className={styles.noReg}>
                  ...
                  <div className={styles.card_title}>
                     <h3>{data.name}</h3>
                     <div className={styles.card_sustitle}>
         ...
         <div className={styles.desc}>
            <div className={styles.desc_cont}>
               <p className={styles.descT}>
                  After a successful revamp last year, Techfest is back on the
                  grounds of IIT Bombay, rising greater than ever before. With
                  an aim to promote creative, innovative and technical skills
                  amongst the youth, Techfest is coming to the cities near you
                  through Technorion, our Zonal competitions. We believe
                  everyone should get an equal opportunity to showcase their
                  talents and distance should not create a hindrance. With this
                  underlying spirit, we announce the following Technorion Zonal
                  cities.{" "}
               </p>
