import React, { useState } from "react"; //import whatever images we need and add them in the cityData beside a image tag
...
const WorldMap = () => {
  ...
  return (
    ...
    <div><h1 style={{marginTop:"100px",marginBottom:"10px"}} >TOP HIGHLIGHTS </h1></div>
      ...
      {hoveredCity && (
        <div
        className={`${hoveredCity.name==="NorthEast Asia"||hoveredCity.name==="SouthWest Asia" ? "dropdown-menu75" : "dropdown-menu76"}`}
          style={{
            top: hoveredCity.y,
            left: hoveredCity.x,
