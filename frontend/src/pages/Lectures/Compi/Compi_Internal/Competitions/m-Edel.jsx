        ...
        rows: [
              {
                ...
                content: 'Participants should be Signed in before Registering.Then, follow these steps for registration :www.techfest.org -> Competitions > Cashflow Modelling -> Register -> Fill all your details -> You are registered in that competition. Now you must either Create a team or Join a Team using the registered mail ID.'
              },
              {
    ...
    return (
        <div className={styles.mWholeData}>
            ...
            <div>
              ...
              <li>
              Stage 1:<br/>
              Participants are required to provide a comprehensive summary of their comprehension of the Problem Statement. This summary should encompass a thorough understanding of the challenges and objectives laid out in the Problem Statement document.
              </li>
              <li>
              Stage 2: Finals<br/>
              This stage will involve a physical demonstration, during which the chosen teams will present the functionality of their model.
              </li>
