    ...
    axios
      ...
      .catch((error) => {
        ...
        if (
          ...
          alert(
            "One of the user is not registered. Please register before creating a team."
          );
        } else {
          // Handle other errors
        }
          ...
          <form className={styles.godhelp} onSubmit={handleSubmit}>
            <div className={styles.regFormContainer}>
              ...
              <div className={`row ${styles.multiWrapper}`}>
                <div className={`col-md-6 ${styles.inputWrapper}`}>
                  <label
                    className={`${styles.floatingLabel1} ${styles.formLabel}`}
                  >
                    Participant 1 Name:
                  </label>
                  <input
              ...
              {romeo ? (
                <div className={styles.formSubmit}>Submitting...</div>
              ) : (
                <input
                  type="submit"
                  value="Submit"
