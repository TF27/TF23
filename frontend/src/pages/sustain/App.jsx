      ...
      <div className={styles.content_container}>
        <div>
          ...
          <div onClick={elt_reg} className={styles.register_btn_container}>
            ...
            <h4 style={{letterSpacing:'2px'}}>Register</h4>
            </Button>
          </div>
          <br/>
          
          <Content
            title="ELT-Incentives"
            content=""
          />
          <p className={styles.para}>
          1. Certification from Techfest, IIT Bombay and Energy Swaraj<br/>
            2. Backed by AICTE and NITI Aayog<br/>
          ...
          <Content
            ...
            content=""
          />
          <p >Rewards for Shart Lagao Bijli Bachao Challenge
            Reduce Electricity Consumption Challenge
            The Foundation will recognise your efforts by giving you following certificates:
            <br/>
            <br/>
            ...
            The Energy Swaraj Foundation will send one legant and valuable White Kurta with “Energy Swaraj” embroidery on it at front and back.</p>
          <br/>
        ...
        <div className="col-md-6 class1" >
          <img src={esf_logo} alt="sorry no image" className="img-fluid" width="80%" height="100%"/>
        </div>
        <div className="col-md-6 class2">
          
          <p className="visiontext" ><br/>Click below link<br/> <a style={{fontSize:'25px'}} href="mailto:info@energyswaraj.org">info@energyswaraj.org</a>
          </p>
        </div>
      </div>
