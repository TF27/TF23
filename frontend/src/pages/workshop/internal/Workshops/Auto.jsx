      ...
      <div className={styles.impdata}>
        ...
        <div className={styles.information}>
          <div id="About" className={`${styles.info} ${activeCity === 'About' ? styles.show : styles.hide}`}>
            ...
            Learn about the automobile design and the growing electric vehicles industry<br /> <br />
          ...
          <div id="Contact" className={`${styles.info} ${activeCity === 'Contact' ? styles.show : styles.hide}`}>
            <div className={styles.info_tab}>
              <div className={styles.info_data}>
                Krishna Rathi<br/>
                    <div className="col-3 contactNum" onClick={() => window.location.href = `tel:7014036467`}>+91 70140 36467</div>
                    <div className="col-3 contactMail" onClick={() => window.location.href = `krishna@techfest.org`}>krishna@techfest.org</div>
