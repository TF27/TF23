        ...
        <div className={styles.information}>
          ...
          <div id="Contact" className={`${styles.info} ${activeCity === 'Contact' ? styles.show : styles.hide}`}>
            <div className={styles.info_tab}>
              <div className={styles.info_data}>
                Sarvesh Bang<br/>
                    <div className="col-3 contactNum" onClick={() => window.location.href = `tel:8766784117`}>+91 87667 84117</div>
                    <div className="col-3 contactMail" onClick={() => window.location.href = `sarvesh@techfest.org`}>sarvesh@techfest.org</div>
