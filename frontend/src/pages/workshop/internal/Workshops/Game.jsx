      ...
      <div className={styles.impdata}>
        ...
        <div className={styles.information}>
          ...
          <div id="Structure" className={`${styles.info} ${activeCity === 'Structure' ? styles.show : styles.hide}`}>
            <div className={styles.info_tab}>
            <div className={styles.info_data}>
            <b>Register and Pay before 12th December 2023 to avail the workshop at the early bird price</b> <br /><br />
            Group Discounts: <br/>
          ...
          <div id="Contact" className={`${styles.info} ${activeCity === 'Contact' ? styles.show : styles.hide}`}>
            <div className={styles.info_tab}>
              ...
              Atharv Apshinge<br/>
                    ...
                    <div className="col-3 contactMail" onClick={() => window.location.href = `varun@techfest.org`}>atharv@techfest.org</div>
