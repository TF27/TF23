    ...
    <div className={styles.mWholeData}>
      <div>
        ...
        >
          ...
          Learn to identify and fix security threats breaching the company's security system<br /> <br />
      ...
      <div>
        ...
        >
          <div className={`${styles.abt_rect1} ${styles.whatd_rect1}`}></div>
          <div className={`${styles.abt_rect2} ${styles.whatd_rect2}`}>
          Register and Pay before 15th December 2023 to avail the workshop at the early bird price <br /><br />
            Group Discounts: <br/>
        ...
        >
          ...
          <div className={`${styles.abt_rect2} ${styles.whatd_rect2}`}>
            ...
            <div
              ...
              onClick={() => (window.location.href = `tel:8766784117`)}
            >
              +91 87667 84117
            </div>
            <div
              ...
              onClick={() =>
                (window.location.href = `mailto:sarvesh@techfest.org`)
              }
            >
              sarvesh@techfest.org
            </div>
          </div>
        </div>
      </div>
